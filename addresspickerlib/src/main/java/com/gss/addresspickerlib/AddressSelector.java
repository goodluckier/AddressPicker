...
public class AddressSelector extends LinearLayout implements View.OnClickListener {
    ...
    private ArrayList<NameInterface> cities;
    ...
    public void setCities(ArrayList cities) {
        if (cities == null || cities.size() <= 0)
            return;
        if (cities.get(0) instanceof NameInterface) {
            this.cities = cities;
            ...
            holder.itemView.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    if (onItemClickListener != null) {
                        onItemClickListener.onItemClick(AddressSelector.this, (NameInterface) v.getTag(), tabIndex);
                        tabs.get(tabIndex).setText(((NameInterface) v.getTag()).getName());
